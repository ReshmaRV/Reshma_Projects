<%-- 
    ...
    Created on : 5 Feb, 2015, 9:22:40 AM
...
<head>
    ...
    <jsp:useBean id="con" class="beanfiles.Profile"/>
    <jsp:setProperty name="con" property="*"/>
    <script>
        function back(){alert("haiii");
		...
		<div id="content_right">
		  <div class="margin_bottom_20">&nbsp;</div>
            ...
            <div class="right_col_section_w420">
             <%
                    con.setUid(session.getAttribute("uid").toString());
                    if(con.putData(5)>0){
                       %>
                        <script>
                ...
                %>
                <!--<input type="button" value="Back to home" onclick="back()"/>-->
